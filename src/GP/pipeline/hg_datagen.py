...
class MultiPuzzleDataSet(object):
    ...
    Arguments:
        render_flag: choose which geometry to render
    '''
    def __init__(self, render_flag, q_range=1.0, res=256, patch_size=32, aug_patch=False, aug_scaling=0.0, aug_dict={}, flat_surface=False):
        self.c_dim = 4
        self.d_dim = 1
        self.render_flag = render_flag
        self.res = res
...
def create_multidataset(ompl_cfgs, geo_type, res=256, aug_patch=True, aug_scaling=1.0, aug_dict={}):
    render_flag = pyosr.Renderer.NO_SCENE_RENDERING
    patch_size=64
