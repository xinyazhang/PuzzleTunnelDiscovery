...
ExternalProject_Add(ext_ompl_app
	...
	CMAKE_ARGS -E env PKG_CONFIG_PATH=$ENV{PKG_CONFIG_PATH} ${CMAKE_COMMAND} -DOMPL_BUILD_DEMOS=OFF -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${EXTERNAL_PROJECTS_INSTALL_PREFIX} -DCMAKE_PREFIX_PATH=${EXTERNAL_PROJECTS_INSTALL_PREFIX}:${INSTALLED_PKG_CONFIG}
