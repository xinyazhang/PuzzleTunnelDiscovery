...
./pretrain-d.sh --ferev 11 --elu \
	...
	--iter 524288 \
	--eval \
	--mispout evaluation/Resnet-View-0-of-14-A12-Rev-11-MISP-256/ \
	--view 0 \
	--viewset cube \
	--featnum 512 \
	--imhidden 512 512 \
	...
	--sampletouse 524288 \
	--samplebatching 64 \
	--samplebase 1048576 > evaluation/Resnet-View-0-of-14-Rev-11-Feat-512-524288-fixcam.out
...
./pretrain-d.sh --ferev 11 --elu \
	...
	--sampletouse 524288 \
	--samplebatching 64 \
	--samplebase 1048576 > evaluation/Resnet-View-0-of-14-Rev-11-Feat-256-524288-fixcam.out
